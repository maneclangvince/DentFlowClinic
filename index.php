            ...
            <div class="col-md-4">
                <div class="card border-0 shadow-sm rounded-4 p-0 text-center h-100 portal-card bg-white">
                    <div class="card-body d-flex flex-column justify-content-between">
                        ...
                        <a href="dentist_login.php" class="btn btn-dark fw-bold w-100 rounded-3 shadow-sm">Go to Dentist UI</a>
                    </div>
                </div>
            </div>
                ...
                <div class="card border-0 shadow-sm rounded-4 p-0 text-center h-100 portal-card bg-white">
                    <div class="card-body d-flex flex-column justify-content-between">
                        <div>
                            ...
                            <h2 class="h4 fw-bold text-dark mb-2">Receptionist Portal</h2>
                            <p class="text-muted">Manage billing, checkout, inventory, and clinic status.</p>
                        </div>
                        <a href="receptionist_login.php" class="btn btn-secondary fw-bold w-100 rounded-3 shadow-sm">Go to Receptionist UI</a>
                    </div>
                </div>
            </div>
        </div>
