...
<body>
    ...
    <section class="services-section">
        <div class="container">
            ...
            <p class="section-subtitle">Professional dental care tailored to your needs</p>
            
            <div class="row g-4 justify-content-center">
                <?php 
                $services = $_SESSION['dental_services'] ?? [];
                $icons = ['fa-tooth', 'fa-user-md', 'fa-star', 'fa-heartbeat', 'fa-gem'];
                
                foreach ($services as $index => $service): 
                    $icon = $icons[$index % count($icons)] ?? 'fa-tooth';
                ?>
                    <div class="col-md-6 col-lg-4">
                        <div class="service-card">
                            <i class="fas <?php echo $icon; ?> service-icon"></i>
                            <h3 class="service-name"><?php echo htmlspecialchars($service['name']); ?></h3>
                            <p class="service-description"><?php echo htmlspecialchars($service['description'] ?? 'Professional dental service for your oral health needs.'); ?></p>
                            <span class="service-price">₱<?php echo number_format($service['price'], 2); ?> <span>per session</span></span>
                        </div>
                    </div>
                <?php endforeach; ?>
            </div>
